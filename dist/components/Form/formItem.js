...
export var FormItem = function (props) {
    ...
    return (React.createElement("div", { className: rowClass },
        label &&
            React.createElement("div", { className: 'mx-form-item-label' },
                React.createElement("label", { title: label, className: labelClass }, label)),
        React.createElement("div", { className: 'mx-form-item' },
            React.createElement("div", { className: itemClass }, returnChildNode),
            hasError &&
                React.createElement("div", { className: 'mx-form-item-explain' },
