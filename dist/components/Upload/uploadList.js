...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "mx-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "mx-upload-list-item", key: item.uid },
