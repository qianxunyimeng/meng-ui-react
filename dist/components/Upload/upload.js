...
export var Upload = function (props) {
    ...
    return (React.createElement("div", { className: "mx-upload-component" },
        React.createElement("div", { className: "mx-upload-input", style: { display: 'inline-block' }, onClick: handleClick },
            drag ?
                React.createElement(Dragger, { onFile: function (files) { uploadFiles(files, true); } }, children) :
                children,
            React.createElement("input", { className: "mx-file-input", style: { display: 'none' }, ref: fileInput, onChange: handleFileChange, type: "file", accept: accept, multiple: multiple })),
