...
export const FormItem: FC<FormItemProps> = (props) => {
  ...
  const rowClass = classNames('mx-row', {
  ...
  const itemClass = classNames('mx-form-item-control', {
  ...
  return (
    <div className={rowClass}>
      { label &&
        <div className='mx-form-item-label'>
          <label title={label} className={labelClass}>
            {label}
          </label>
        </div>
      }
      <div className='mx-form-item'>
        <div className={itemClass}>
          {returnChildNode}
        </div>
        { hasError && 
          <div className='mx-form-item-explain'>
